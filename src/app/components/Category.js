...
export default function Category({isActive}){
    ...
    return(
        <div className={`category bg-light1 hover:bg-accent1 p-3 mx-3 rounded-lg flex items-center gap-3 transition ${isActive?"bg-accent1":""}`}>
            <div className="relative w-12 h-12">
                ...
                <div className="text mt-[2px] text-light1 font-bold absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">12</div>
            </div>
            <div className="text bangla">
                <div className="title text-lg text-dark4 font-medium">ওহীর সূচনা অধ্যায়</div>
