...
export default function Book({isActive}){
    ...
    return(
        <div className={`book group p-3 mx-3 rounded-lg flex items-center gap-3 transition ${isActive?"bg-accent1":"bg-light1 hover:bg-accent1"}`}>
