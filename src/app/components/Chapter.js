...
export default function Chapter({isActive}){
    ...
    return(
        <button className={`chapter text-left dark:text-light1 group p-3 mx-3 rounded-lg flex items-center gap-3 transition ${isActive?"bg-accent1 dark:bg-dark1":"bg-light1 dark:bg-dark3 hover:bg-accent1 dark:hover:bg-dark1"}`}>
            ...
            <div className="text bangla">
                <div className="title text-lg dark:text-light1 font-medium">ওহীর সূচনা অধ্যায়</div>
