...
export default function Home() {
    ...
    useEffect(() => {
      const fetchInitialData = async () => {
        try {
          ...
          setHadiths(initialData.hadiths || []);
    ...
    return (
        <main className={`bg-light3 dark:bg-dark4 text-dark4 dark:text-light3 w-[100svw] h-[100svh] overflow-hidden font-inter ${dark? "dark":""}`}>
            ...
            <ModalShare isModalShareOpen={isModalShareOpen} closeShare={closeShare}/>
            ...
            <div className="top-nav-container bg-light1 dark:bg-dark3 h-[80px] flex justify-between items-center px-5">
                <div className="logo-container flex items-center gap-3">
                    ...
                    <div className="text">
                        <div className="title bangla hidden xl:block text-lg font-bold dark:text-light3">হাদিস সমূহ</div>
            ...
            <div className="body-container bg-light3 dark:bg-dark4 flex relative">


                <div className="left-nav-container bg-light1 dark:bg-dark3 w-[80px] h-[calc(100svh-80px)] overflow-y-scroll relative hidden xl:flex xl:flex-col xl:justify-center xl:items-center gap-3 text-2xl pb-20">
                ...
                <div className="category-and-main-container w-full h-[calc(100svh-80px-24px)] flex gap-3 py-3 xl:pl-3 relative">
                    ...
                    <div className="category-col-container min-w-[300px] h-[calc(100svh-80px-24px)] hidden xl:flex xl:flex-col bg-light1 dark:bg-dark3 rounded-lg">
                    ...
                    <div className="hadiths-container w-full h-[calc(100svh-80px-24px)] overflow-y-scroll px-3 xl:px-0 xl:pr-3">
                        <button className="show-chapter-container w-full bg-light1 dark:bg-dark3 p-3 rounded-lg flex items-center xl:hidden gap-3 mb-3" onClick={openCategory}>
                            <div className="icon text-xl relative top-1"><iconify-icon icon="ic:round-menu"></iconify-icon></div>
                            <div className="text dark:text-light3 bangla text-xl">সহিহ বুখারী</div>
                        </button>

                        <div className="book-title-container bg-light1 dark:bg-dark3 rounded-lg mb-3">
                            <div className="breadcrumb-container bg-light2 dark:bg-dark3 text-light4 dark:text-light4 flex items-center px-5 py-3 rounded-t-lg">
                            ...
                            <div className="flex justify-between items-center px-5 py-3 gap-3">
                                <div className="left flex items-center gap-5">
                                    ...
                                    <div className="text bangla">
                                        <div className="title text-lg text-dark4 dark:text-light3 font-medium">সহিহ বুখারী</div>
                                        <div className="subtitle text-sm text-light4">সর্বমোট হাদিস - ৭৫৬৩</div>
                                    </div>
                                </div>
                                <div className="right arabic text-2xl font-medium dark:text-light3">صحيح البخاري</div>
                            </div>
                        </div>

                        {
                            chapters.map((chapter, chapter_index) => {
                                return(
                                    <div className="chapter-container flex flex-col flex-grow-1 gap-3">
                                        <div className="chapter-title-container bg-light1 dark:bg-dark3 p-5 rounded-lg flex items-center gap-3">
                                            <div className="bg-accent2 text-light1 font-bold w-10 h-10 flex justify-center items-center rounded-lg">{chapter.chapter_id}</div>
                                            <div className="text dark:text-light3 bangla text-xl">{chapter.title}</div>
                                        </div>
                                        {
                                            sections.map((section, section_index) => {
                                                return(
                                                    <div className="section-container flex flex-col flex-grow-1 gap-3">
                                                        <div className="section-title-container bg-light1 dark:bg-dark3 rounded-lg">
                                                        ...
                                                        </div>
                                                        {
                                                            hadiths.map((hadith, hadith_index) => {
                                                                return(
                                                                    <div className="hadith bg-light1 dark:bg-dark3 p-5 rounded-lg">
                                                                        <div className="title-container w-full flex justify-between items-center mb-5">
                                                                            <div className="flex gap-3 items-center">
                                                                                ...
                                                                                <p className="title text-accent2 text-lg font-semibold">{hadith.hadith_id}</p>
                                                                            </div>
                                                                            <a className="block xl:hidden bangla bg-accent2 text-light1 text-sm font-semibold px-3 py-1 rounded-lg" href="#">{hadith.grade}</a>
                                                                        </div>
                                                                        <div className="arabic text-end text-[1.5rem] lg:text-[2.25rem] dark:text-light3 word-spacing-medium xl:word-spacing-loose leading-loose px-5 mb-10">{hadith.ar}</div>
                                                                        {/* <div className="arabic text-end text-2xl xl:text-4xl dark:text-light3 leading-loose word-spacing-loose flex-grow-1 px-5 mb-5">حَدَّثَنَا الْحُمَيْدِيُّ عَبْدُ اللَّهِ بْنُ الزُّبَيْرِ، قَالَ حَدَّثَنَا سُفْيَانُ، قَالَ حَدَّثَنَا يَحْيَى بْنُ سَعِيدٍ الأَنْصَارِيُّ، قَالَ أَخْبَرَنِي مُحَمَّدُ بْنُ إِبْرَاهِيمَ التَّيْمِيُّ، أَنَّهُ سَمِعَ عَلْقَمَةَ بْنَ وَقَّاصٍ اللَّيْثِيَّ، يَقُولُ سَمِعْتُ عُمَرَ بْنَ الْخَطَّابِ ـ رضى الله عنه ـ عَلَى الْمِنْبَرِ قَالَ سَمِعْتُ رَسُولَ اللَّهِ صلى الله عليه وسلم يَقُولُ ‏ "‏ إِنَّمَا الأَعْمَالُ بِالنِّيَّاتِ، وَإِنَّمَا لِكُلِّ امْرِئٍ مَا نَوَى، فَمَنْ كَانَتْ هِجْرَتُهُ إِلَى دُنْيَا يُصِيبُهَا أَوْ إِلَى امْرَأَةٍ يَنْكِحُهَا فَهِجْرَتُهُ إِلَى مَا هَاجَرَ إِلَيْهِ</div> */}
                                                                        <div className="narrator bangla text-accent2 font-bold px-5 mb-1">{hadith.narrator}:</div>
                                                                        <div className="translation bangla text-lg dark:text-light3 px-5 mb-5">{hadith.bn}</div>
                                                                        <div className="xl:flex xl:justify-between xl:items-center px-5">
                                                                            <div className="hadith-quality-container hidden xl:flex items-center gap-3">
                                                                                <div className="title bangla font-semibold dark:text-light3">হাদিসের মান :</div>
                                                                                <a className="block bangla bg-accent2 text-light1 text-sm font-semibold px-3 py-1 rounded-lg" href="#">{hadith.grade}</a>
                                                                            </div>
                                                                            <div className="buttons w-full xl:w-auto flex justify-around xl:justify-normal items-center gap-7">
                                                                                ...
                                                                                <button className="btn-hadith-action group relative" onClick={openBookmark}>
                                                                                    <div className="tag w-fit bg-dark1 text-light1 px-3 py-2 rounded-lg text-[11px] hidden group-hover:block absolute left-1/2 -translate-x-1/2 -top-[110%] transition">বুকমার্ক</div>
                                                                                ...
                                                                                <button className="btn-hadith-action group relative" onClick={openShare}>
                                                                                    <div className="tag w-fit bg-dark1 text-light1 px-3 py-2 rounded-lg text-[11px] hidden group-hover:block absolute left-1/2 -translate-x-1/2 -top-[110%] transition">শেয়ার</div>
                                                                                ...
                                                                                <button className="btn-hadith-action group relative">
                                                                                    <div className="tag w-fit bg-dark1 text-light1 px-3 py-2 rounded-lg text-[11px] hidden group-hover:block absolute left-1/2 -translate-x-1/2 -top-[110%] transition">রিপোর্ট</div>
                                                                                ...
                                                                                <a className="btn-hadith-action block group relative" href="#">
                                                                                    <div className="tag w-fit bg-dark1 text-light1 px-3 py-2 rounded-lg text-[11px] hidden group-hover:block absolute left-1/2 -translate-x-1/2 -top-[110%] transition">ডিরেক্ট</div>
                        ...
                        <div className="phone-spacer block xl:hidden w-full h-[60px]"></div>
