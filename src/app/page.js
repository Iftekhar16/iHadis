...
export default function Home() {
    ...
    return (
        <main className={`bg-light3 dark:bg-dark4 text-dark4 dark:text-light1 w-[100svw] h-[100svh] overflow-hidden font-inter ${dark? "dark":""}`}>
            <ModalSettings isSettingsModalOpen={isSettingsModalOpen} closeSettings={closeSettings} dark={dark} toggleDark={toggleDark}/>
            {/* <ModalSettings/> */}
            <div className="top-nav-container bg-light1 dark:bg-dark3 h-[80px] flex justify-between items-center px-5">
                <div className="logo-container flex items-center gap-3">
                    ...
                    <div className="text">
                        <div className="title bangla text-lg font-bold dark:text-light1">হাদিস সমূহ</div>
                        <div className="subtitle bangla text-sm text-dark1 dark:text-light4">হাদিস পড়ুন শিখুন এবং জানুন</div>
                    </div>
                </div>
            ...
            <div className="body-container flex">
                <div className="left-nav-container bg-light1 dark:bg-dark3 w-[80px] h-[calc(100svh-70px)] overflow-y-scroll relative flex flex-col justify-center items-center gap-3 text-2xl">
                ...
                <div className="w-[calc(100svw-80px)] h-[calc(100svh-80px)] flex gap-3 bg-light3 dark:bg-dark4 relative p-3">
                    ...
                    <div className="category-col-container w-[300px] h-[calc(100svh-80px-24px)] flex flex-col bg-light1 dark:bg-dark3 rounded-lg">
                    ...
                    <div className="hadiths-container w-[calc(100svw-80px-300px-36px)] h-[calc(100svh-80px-24px)] overflow-y-scroll rounded-lg flex flex-col gap-3">
                        <div className="book-title-container bg-light1 dark:bg-dark3 rounded-lg">
                            <div className="breadcrumb-container bg-light2 dark:bg-dark3 text-light4 dark:text-light1 flex items-center px-5 py-3">
                        ...
                        <div className="book-container flex flex-col flex-grow-1 gap-3">
                            ...
                            <div className="chapter-container flex flex-col flex-grow-1 gap-3">
                                ...
                                <div className="chapter w-[calc(100svw-80px-300px-36px)] bg-light1 dark:bg-dark3 p-5 rounded-lg">
                                    ...
                                    <div className="arabic text-end text-4xl dark:text-light1 leading-loose word-spacing-loose flex-grow-1 px-5 mb-5">حَدَّثَنَا الْحُمَيْدِيُّ عَبْدُ اللَّهِ بْنُ الزُّبَيْرِ، قَالَ حَدَّثَنَا سُفْيَانُ، قَالَ حَدَّثَنَا يَحْيَى بْنُ سَعِيدٍ الأَنْصَارِيُّ، قَالَ أَخْبَرَنِي مُحَمَّدُ بْنُ إِبْرَاهِيمَ التَّيْمِيُّ، أَنَّهُ سَمِعَ عَلْقَمَةَ بْنَ وَقَّاصٍ اللَّيْثِيَّ، يَقُولُ سَمِعْتُ عُمَرَ بْنَ الْخَطَّابِ ـ رضى الله عنه ـ عَلَى الْمِنْبَرِ قَالَ سَمِعْتُ رَسُولَ اللَّهِ صلى الله عليه وسلم يَقُولُ ‏ "‏ إِنَّمَا الأَعْمَالُ بِالنِّيَّاتِ، وَإِنَّمَا لِكُلِّ امْرِئٍ مَا نَوَى، فَمَنْ كَانَتْ هِجْرَتُهُ إِلَى دُنْيَا يُصِيبُهَا أَوْ إِلَى امْرَأَةٍ يَنْكِحُهَا فَهِجْرَتُهُ إِلَى مَا هَاجَرَ إِلَيْهِ</div>
