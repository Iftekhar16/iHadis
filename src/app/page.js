        ...
        <main className="bg-light3 text-dark4 w-[100svw] h-[100svh] overflow-hidden font-inter">
            ...
            <div className="body-container flex">
                ...
                <div className="w-[calc(100svw-80px)] h-[calc(100svh-80px)] flex gap-3 bg-light3 relative p-3">
                    ...
                    <div className="hadiths-container w-[calc(100svw-80px-300px-36px)] h-[calc(100svh-80px-24px)] overflow-y-scroll rounded-lg flex flex-col gap-3">
                        <div className="book-title-container bg-light1 rounded-lg">
                            <div className="breadcrumb-container bg-light2 text-light4 flex items-center px-5 py-3">
                            ...
                            <div className="flex justify-between items-center px-5 py-3 gap-3">
                                <div className="left flex items-center gap-5">
                                    ...
                                    <div className="text bangla">
                                        <div className="title text-lg text-dark4 font-medium">সহিহ বুখারী</div>
                                        <div className="subtitle text-sm text-light4">সর্বমোট হাদিস - ৭৫৬৩</div>
                                    </div>
                                </div>
                                <div className="right text-2xl font-medium">
                                    صحيح البخاري
                                </div>
                            </div>
                        </div>
                        <div className="book-container flex flex-col flex-grow-1 gap-3">
                            <div className="chapter-title-container bg-light1 p-5 rounded-lg flex items-center gap-3">
                                <div className="bg-accent2 text-light1 font-bold w-10 h-10 flex justify-center items-center rounded-lg">১</div>
                                <div className="text bangla text-xl">ওহীর সূচনা অধ্যায়</div>
                            </div>
                            <div className="chapter-container flex flex-col flex-grow-1 gap-3">
                                <div className="chapter-title-container bg-light1 rounded-lg">
                                    <div className="flex items-center gap-3 px-5 py-3">
                                        ...
                                        <div className="title bangla text-lg text-dark4 font-medium">১/১. অধ্যায়ঃ</div>
                                    </div>
                                    <div className="bangla text-lg text-dark4 font-medium px-5 pb-3">আল্লাহ্‌র রসূল (সাল্লাল্লাহু 'আলাইহি ওয়া সাল্লাম)- এর প্রতি কীভাবে ওয়াহী [১] শুরু হয়েছিল।</div>
                                    <hr/>
                                    <div className="bangla text-dark1 font-medium px-5 py-3">এ মর্মে আল্লাহ তা’আলার বাণীঃ “নিশ্চয়ই আমি আপনার প্রতি সেরূপ ওয়াহী প্রেরণ করেছি যেরূপ নূহ ও তাঁর পরবর্তী নবীদের প্রতি ওয়াহী প্রেরণ করেছিলাম”। (সূরা আন-নিসা ৪/১৬৩)</div>
                                </div>
                                <div className="chapter w-[calc(100svw-80px-300px-36px)] bg-light1 p-5 rounded-lg">
                                    ...
                                    <div className="arabic text-end text-4xl leading-loose word-spacing-loose flex-grow-1 px-5 mb-5">حَدَّثَنَا الْحُمَيْدِيُّ عَبْدُ اللَّهِ بْنُ الزُّبَيْرِ، قَالَ حَدَّثَنَا سُفْيَانُ، قَالَ حَدَّثَنَا يَحْيَى بْنُ سَعِيدٍ الأَنْصَارِيُّ، قَالَ أَخْبَرَنِي مُحَمَّدُ بْنُ إِبْرَاهِيمَ التَّيْمِيُّ، أَنَّهُ سَمِعَ عَلْقَمَةَ بْنَ وَقَّاصٍ اللَّيْثِيَّ، يَقُولُ سَمِعْتُ عُمَرَ بْنَ الْخَطَّابِ ـ رضى الله عنه ـ عَلَى الْمِنْبَرِ قَالَ سَمِعْتُ رَسُولَ اللَّهِ صلى الله عليه وسلم يَقُولُ ‏ "‏ إِنَّمَا الأَعْمَالُ بِالنِّيَّاتِ، وَإِنَّمَا لِكُلِّ امْرِئٍ مَا نَوَى، فَمَنْ كَانَتْ هِجْرَتُهُ إِلَى دُنْيَا يُصِيبُهَا أَوْ إِلَى امْرَأَةٍ يَنْكِحُهَا فَهِجْرَتُهُ إِلَى مَا هَاجَرَ إِلَيْهِ</div>
